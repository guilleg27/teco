(function ($) {
    ...
    $("#contact8gb").submit(function (e) {
        ...
        var pubId      = $("#form-pubId8gb").val();
        var providerId = $("#form-providerId8gb").val();
        // var captcha    = $("#g-recaptcha-response").val();
        var captcha8gb    = $("#8gb-captcha").val();
        var dataString = 'name='+name+'&email='+email+'&phone='+phone+'&plan='+plan+'&ktoken='+ktoken+'&gen='+gen+'&captcha8gb='+captcha8gb+'&pubId='+pubId+'&providerId='+providerId;
    ...
    $("#contact12gb").submit(function (e) {
        ...
        // var captcha  = $("#g-recaptcha-response").val();
        var captcha12gb = $("#12gb-captcha").val();
        var pubId       = $("#form-pubId12gb").val();
        var providerId  = $("#form-providerId12gb").val();
        var dataString = 'name='+name+'&email='+email+'&phone='+phone+'&plan='+plan+'&ktoken='+ktoken+'&gen='+gen+'&captcha12gb='+captcha12gb+'&pubId='+pubId+'&providerId='+providerId;
    ...
    $("#contact20gb").submit(function (e) {
        ...
        // var captcha  = $("#g-recaptcha-response").val();
        var captcha20gb = $("#20gb-captcha").val();
        var pubId       = $("#form-pubId20gb").val();
        var providerId  = $("#form-providerId20gb").val();
        var dataString = 'name='+name+'&email='+email+'&phone='+phone+'&plan='+plan+'&ktoken='+ktoken+'&gen='+gen+'&captcha20gb='+captcha20gb+'&pubId='+pubId+'&providerId='+providerId;
