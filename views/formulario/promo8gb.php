...
<body class="wow-animate">
    ...
    <div id="page-wraper">
        ...
        <!-- Page Intro -->
        <section id="inner-intro" class="container-fluid no-padding highlight portabilidad2 overlay-dark40" data-background-img="img/fondo-persona.jpg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center successContent8GB" style="  height: 107%;background-color: white;position: absolute;z-index: 30;left: 0;top: 0;">
                        ...
                        <form id="contact" class="contact-form row" role="form">
                         <div class="col-md-12 text-center" style="height: 20px">
                            ...
                            <div style="text-align: center; margin: 0 auto; display: inline-block;">
                                    <!-- <div class="g-recaptcha" data-sitekey="6LdJsMAUAAAAAA2MhUqQsHya3AoTjP0z_TH02bkX"></div> -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="font-size: 12px">
           BENEFICIO DE ALCANCE NACIONAL, VÁLIDO DESDE EL 01/10/18 HASTA EL 31/12/19. SE ASIGNARÁ POR ÚNICA VEZ UN PACK DE 10 GB A AQUELLAS LÍNEAS PERSONAL QUE SOLICITEN EL BENEFICIO, DESCARGANDO Y AUTENTICÁNDOSE DESDE LA APP “MI PERSONAL”. LAS LÍNEAS RECEPTORAS DEL BENEFICIO DEBERÁN CONTAR ÚNICAMENTE CON PLANES “PERSONAL CON FACTURA” O “PERSONAL ABONO FIJO” CON CUOTA DE DATOS MENSUAL ASIGNADA, DEL SEGMENTO INDIVIDUOS. NO VÁLIDO PARA “PERSONAL CON TARJETA” NI PARA PLANES BIPY O FECOSUR. NO APLICA EN ROAMING INTERNACIONAL. LA VIGENCIA DEL PACK SERÁ HASTA AGOTAR LOS 10 GB ASIGNADOS O AL HABER TRANSCURRIDO 30 DÍAS DESDE LA ACTIVACIÓN, LO QUE SUCEDA PRIMERO. SE CONSUMIRÁN PRIMERO LOS DATOS CUYO VENCIMIENTO SE ENCUENTRE MÁS PRÓXIMO. LA VELOCIDAD DE NAVEGACIÓN DEPENDERÁ DE LOS RECURSOS DISPONIBLES DE LA RED HASTA ALCANZAR LOS 10 GB DE CONSUMO, A PARTIR DEL CUAL LA VELOCIDAD SERÁ DE HASTA 32 KBPS. EL BENEFICIO IMPACTARÁ DENTRO DEL PLAZO DE 48 HS POSTERIORES A LA SOLICITUD DESDE LA APP “MI PERSONAL”. LA LÍNEA PERSONAL RECIBIRÁ UN SMS CON LA CONFIRMACIÓN DEL BENEFICIO. PARA RECIBIR EL BENEFICIO LAS LÍNEAS DEBEN ENCONTRARSE ACTIVAS. UNA MISMA LÍNEA PERSONAL NO PODRÁ RECIBIR MÁS DE UN BENEFICIO DURANTE LA VIGENCIA DE ESTA PROMOCIÓN. MÁS INFORMACIÓN EN *111. TELECOM ARGENTINA S.A. ALICIA MOREAU DE JUSTO 50. C.A.B.A. CUIT: 30-63945373-8.
        </div>
